...
export default function Loader({ message = "" }) {
    return (
        <div style={{ borderRadius: "inherit" }} className="bg-[#000000b7] absolute top-0 left-0 flex flex-col space-y-1 items-center justify-center h-full w-full rounded-inherit">
