...
export default function PlayListCard({ thumbnail = "https://res.cloudinary.com/duhmeadz6/image/upload/v1729707756/thumbnail_cvabme.jpg", numberOfVideos = 0, channeName = "", channelAvatar = "", videoTitle = "" }) {
    return (
        <div className="max-w-80 min-w-80 rounded-2xl bg-[#ffffff18] pb-1 my-6 mx-2 cursor-pointer hover:shadow hover:shadow-[#ffffff20] hover:scale-105 transition-transform duration-200 ease-in-out">
            <div className="relative flex justify-center">
                ...
                <span className="absolute bg-gray-600 z-10 font-bold bottom-0 left-0 m-2 py-0 px-2 rounded-lg text-md">{numberOfVideos} videos</span>
